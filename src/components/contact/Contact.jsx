...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "SMDC Charms Condo, Cainta Rizal",
  },
  {
    icon: faEnvelope,
    title: "My Email",
      ...
      >
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          ...
          <div className="w-full overflow-y-scroll py-6.5">
            <p className="text-xl mb-2 xs:text-2xl sm:text-2xl md:text-[38px] font-semibold text-[#002F6C] lg:hidden text-center">
              Let’s discuss your Project
            </p>
            <Form />
          </div>
